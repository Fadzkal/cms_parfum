# app.py (VERSI FINAL DENGAN INTEGRASI SEMUA DASHBOARD)

from flask import Flask, request, jsonify, redirect, url_for, render_template, session
from bson.objectid import ObjectId
from functools import wraps
import time
from models import get_user_collection, get_asset_collection, get_wo_collection, get_inventory_collection, get_schedule_collection
...
def create_wo_request():
    ...
    wo_data = {
        ...
        "components_affected": selected_components,
...
# 7. API untuk Teknisi: Menyelesaikan WO
...
def update_inventory(item_id):
    ...
    if 'current_stock' in data:
        if data['current_stock'] < data.get('min_stock', 0):
...
def get_dashboard_kpi():
    ...
    # MTTR
    mttr_data = calculate_mttr().get_json()
